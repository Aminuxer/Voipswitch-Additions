...
$title = 'Клиенты, по которым давно не было активности (звонков, платежей, списаний)';
...
WHERE ld.assigned != 0
  ...
  -- AND cs.login NOT IN ( 000111187, 000200078, 000200151, 000200171, 000200172, 000200196,000200240,000200814,000200815,000200816,000200878,000201041,000201054,000202197,000202847,000202889,000205384,000205674,000206045,000206067,000206100,000206101 )
HAVING last_discharge < '$cut_date' and last_payment < '$cut_date' AND last_call < '$cut_date'
ORDER BY last_payment DESC") or print mysqli_error();
...
print "
Этот отчет позволяет найти номера, по которым давно нет совсем никакой активности.<Br/><Br/>
...
не было зафиксировано звонков, платежей или списаний за номер после даты среза.
...
Списание - Списание ежемесячной суммы за внешний номер<Br/>
